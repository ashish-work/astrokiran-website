...
function HoroscopeCard() {
    return (
        <div className="container mx-auto mt-20 h-[500px] flex justify-between">
            <div className="flex rounded-[50px] justify-between bg-moonly-horo-card">
                ...
                <div className="mt-10 items-center p-4 pr-20">
                    <div className="flex gap-4 mt-10">
                        <div className="p-2 w-40 h-36 rounded-3xl bg-[#E77272] flex items-center justify-center">
                            <h1 className="text-xl">Love</h1>
                        </div>
                        <div className="p-2 w-40 h-36 rounded-3xl bg-[#8EC4FD] flex items-center justify-center">
                            <h1 className="text-xl">Work</h1>
                        </div>
                    </div>
                    <div className="flex gap-4 mt-8">
                        <div className="p-2 w-40 h-36 rounded-3xl bg-[#80EBB3] flex items-center justify-center">
                            <h1 className="text-xl">Finance</h1>
                        </div>
                        <div className="p-2 w-40 h-36 rounded-3xl bg-[#EE74B8] flex items-center justify-center">
            ...
            <div className="p-2   rounded-[50px] w-96 flex flex-col items-center bg-gradient-to-r from-[#331376] to-[#78dcca]">
