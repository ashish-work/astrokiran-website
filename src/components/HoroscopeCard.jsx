        ...
        <div className="container mx-auto py-20 flex justify-between">
            <div className="flex p-2 border border-gray-300 rounded-[50px] h-[500px] justify-between bg-moonly-horo-card">
                <div className="flex flex-col justify-center ml-4 text-[#E8AED9]">
                    <h1 className="text-4xl mt-10 font-extrabold max-w-xl min-w-96">Daily Horoscope</h1>
                    <h1 className="text-2xl mt-20 font-extrabold max-w-xl min-w-96">Start your day with clarity and confidence by exploring what the stars have in store for you with your daily horoscope predictions.</h1>
                </div>
                <div className="mt-10 items-center px-4">
